      ...
      <div className={styles.bar}>
        ...
        <div onClick={() => { setIsActive(!isActive); }} className={styles.el}>
          ...
          <div className={styles.label}>
            ...
            <motion.p variants={opacity} animate={isActive ? "open" : "closed"}>Fechar</motion.p>
          </div>
        </div>
        <motion.div variants={opacity} animate={!isActive ? "open" : "closed"} className={styles.shopContainer}>
          <p className={styles.shop}>Loja</p>
          <Link href="/cart" className={styles.el}>
